...
const Button = ({ children, disabled, to, type, onButtonClick }) => {
  ...
  const base =
    'bg-[#d92635] text-sm uppercase font-semibold inline-block rounded-full text-stone-200 hover:bg-red-700 transition-colors duration-100 focus:outline-none focus:ring focus:ring-[#d92635] focus:ring-offset-1 disabled:cursor-not-allowed disabled:bg-stone-200 disabled:text-stone-500';
  ...
  const styles = {
    ...
    round: base + ' py-1 px-2.5 md:py-2 md:px-3.5',
  };
